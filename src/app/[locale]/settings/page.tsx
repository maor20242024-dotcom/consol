            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                >
                                    ...
                                    <div className="space-y-2">
                                        {["public", "private", "team"].map((level) => (
                                            <label key={level} className="flex items-center gap-3 cursor-pointer">
                                                <input type="radio" name="profile" defaultChecked={level === "public"} className="w-4 h-4" />
                    ...
                    <TabsContent value="billing">
                        <Card className="bg-slate-800/50 border-primary/20 backdrop-blur">
                            <CardHeader>
                                <CardTitle>{locale === "ar" ? "إعدادات الفواتير" : "Billing Settings"}</CardTitle>
                                <CardDescription>{locale === "ar" ? "إدارة الدفع والاشتراك" : "Manage your payment and subscription"}</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600">
                                    <p className="text-gray-400 text-sm">{locale === "ar" ? "خطتك الحالية" : "Current Plan"}</p>
                                    <p className="text-2xl font-bold text-white mt-2">
                                        {locale === "ar" ? "خطة العميل الذهبي" : "Premium Plan"}
                                    </p>
                                    <p className="text-gray-400 text-sm mt-1">{locale === "ar" ? "350 درهم / الشهر" : "$95/month"}</p>
                                </div>
                                <Button variant="outline" className="w-full border-primary/20">
                                    {locale === "ar" ? "تحديث الطريقة" : "Update Payment Method"}
                                </Button>
                                <Button variant="outline" className="w-full border-primary/20">
